...
<html>
  <head>
	...
	<meta name="description" content="Aplikasi Ujian Online SMPN2Tuntang CBT">
	<meta name="keywords" content="Aplikasi Ujian Online SMPN2Tuntang CBT">
	<meta name="author" content="Danny Juhardi">
    <!-- Bootstrap 3.3.4 -->
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo site_url(); ?>/manager" class="logo">
          ...
          <span class="logo-lg"><b>SMP N 2 Tuntang</b></span>
        </a>
      ...
      <footer class="main-footer">
        ...
        <strong>&copy; 2023 SMP N 2 Tuntang</strong>
      </footer>
