...
class Welcome extends CI_Controller {
    ...
    function logout(){
        ...
        $id = $this->cbt_user_model->get_by_username($username);
        $this->cbt_user_model->update_user_to_offline($id->user_id);
	...
	function check_login(){	
		...
		if($login==1){
            ...
            $this->cbt_user_model->update_user_to_online($id->user_id);
