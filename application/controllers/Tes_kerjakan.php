            ...
            if($this->cbt_tes_user_model->count_by_status_waktuuser($tes_user_id, $waktuuser)->row()->hasil>0){
                ...
                if($query_soal->num_rows()>0){
                    ...
                    if($query_soal->soal_tipe==1){
                        $split_jawaban = explode("~", $jawaban);
                        $jawaban = $split_jawaban[0];
                        $pilihan_jawaban = $split_jawaban[1];
                        ...
                        $data_jawaban['soaljawaban_answer']= $pilihan_jawaban;
                        ...
                        $data_jawaban['soaljawaban_answer']= "-";
                        ...
                        if($query_jawaban->num_rows()>0){
                            ...
                            foreach ($query_jawaban as $jawaban) {
                                ...
                                if($jawaban->soaljawaban_selected==1){
                                    $soal = $soal.'<div class="radio"><label><input type="radio" onchange="jawab()" name="soal-jawaban" value="'.$jawaban->soaljawaban_jawaban_id. '~' .$pilihan_jawaban[$index_pilihan] .'" checked> '.$temp_jawaban.'</label></div>';
                                }else{
                                    $soal = $soal.'<div class="radio"><label><input type="radio" onchange="jawab()" name="soal-jawaban" value="'.$jawaban->soaljawaban_jawaban_id. '~' .$pilihan_jawaban[$index_pilihan] .'" > '.$temp_jawaban.'</label></div>';
                                }
